...
namespace TallerSeries.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "serieID,nombre,genero,foto,video")] Serie serie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "serieID,nombre,genero,foto,video")] Serie serie)
        {
            if (ModelState.IsValid)
            {
